...
PROBE_STATUS_PATH = os.path.join(ANT_OUT_DIR, "btc_worker_adapter_probe_status.json")
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--adapter-probe-out", default=os.path.join(ANT_OUT_DIR, "btc_worker_adapter_probe_hook.json"))
