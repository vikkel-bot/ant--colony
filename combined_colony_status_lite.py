...
def meta_from_doc(doc, fallback_component):
...
def main():
    ...
    ts_utc, cycle_id = now_parts()

    out = {
        "version": "combined_colony_status_lite_v2",
        "ts_utc": ts_utc,
        "cycle_id": cycle_id,
        ...
        "sources": {
            ...
            "edge3_meta": meta_from_doc(edge3_json, "edge3_colony_status_lite"),
            "edge4_meta": meta_from_doc(edge4_json, "edge4_colony_status_lite"),
            "health_meta": meta_from_doc(health_json, "market_health_lite"),
        },
